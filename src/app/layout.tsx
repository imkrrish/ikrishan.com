...
export const metadata: Metadata = {
  ...
  icons: {
    icon: [
      {
        url: "https://assets.ikrishan.com/images/favicon.ico",
        sizes: "32x32",
      },
      {
        url: "https://assets.ikrishan.com/images/favicon.svg",
        sizes: "any",
        type: "image/svg+xml",
        media: "(prefers-color-scheme: light)",
      },
      {
        url: "https://assets.ikrishan.com/images/favicon-dark.svg",
        sizes: "any",
        type: "image/svg+xml",
    ...
    apple: {
      url: "https://assets.ikrishan.com/images/apple-touch-icon.png",
      type: "image/png",
      sizes: "180x180",
    },
  },
